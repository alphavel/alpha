...
namespace Alphavel\Alpha\Console;
...
class Console
{
    ...
    private function groupCommands(): array
    {
        ...
        foreach ($this->commands as $signature => $class) {
            ...
            if (count($parts) > 1) {
                ...
                $groups['_default'][$signature] = $class;
            }
        }

        // Move default to beginning
        $default = $groups['_default'];
    ...
    {
        echo "\033[32m{$this->name}\033[0m - Alphavel Framework CLI\n\n";
        echo "Usage:\n";
